...
export type ImageInvoiceDecision = {
...
const FINANCE_KEYWORD_PATTERNS: RegExp[] = [
    /\binvoice\b/i,
    /\breceipt\b/i,
    /\bstatement\b/i,
    /\bsub\s*-?\s*total\b/i,
...
export function imageTextHasFinancialContent(text: string | undefined | null): boolean {
 ...
 */
export function classifyInvoiceImageAttachment(input: {
    buffer: Buffer
    ocrText?: string | null
}): ImageInvoiceDecision {
