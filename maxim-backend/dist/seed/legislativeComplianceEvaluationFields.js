...
exports.LEGISLATIVE_COMPLIANCE_SECTIONS = void 0;
exports.buildLegislativeComplianceEvaluationFields = buildLegislativeComplianceEvaluationFields;
exports.LEGISLATIVE_COMPLIANCE_SECTIONS = [
    {
...
function buildLegislativeComplianceEvaluationFields() {
    ...
    for (const sec of exports.LEGISLATIVE_COMPLIANCE_SECTIONS) {
    ...
    fields.push({ type: 'TEXT', label: 'Retain 2+ years. Available to MOL Inspector and COR Auditor. Next evaluation within 12 months.', required: false }, { type: 'TEXT', label: '[SECTION]Overall compliance summary', required: false }, { type: 'TEXT', label: 'Overall compliance summary', required: false }, { type: 'TEXT', label: '[SECTION]Sign-offs', required: false }, { type: 'TEXT', label: 'Management Representative — Name', required: false }, { type: 'SIGNATURE', label: 'Management Representative — Signature', required: false }, { type: 'DATE', label: 'Management Representative — Date', required: false }, { type: 'TEXT', label: 'Worker Representative / HSR / JHSC — Name', required: false }, { type: 'SIGNATURE', label: 'Worker Representative / HSR / JHSC — Signature', required: false }, { type: 'DATE', label: 'Worker Representative / HSR / JHSC — Date', required: false });
    return fields;
}
