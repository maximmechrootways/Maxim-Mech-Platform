...
exports.buildFallArrestInspectionChecklistFields = buildFallArrestInspectionChecklistFields;
const FALL_ARREST_ITEMS = [
...
function buildFallArrestInspectionChecklistFields() {
    const fields = [
        ...
        {
            type: 'TEXT',
            label: '[INFO]Inspect all fall arrest equipment before use and remove damaged equipment from service until repaired or replaced.',
            required: false,
        },
        {
            type: 'TEXT',
            label: '[INFO]Complete this checklist once per day. Tick each checklist item after inspection.',
            required: false,
        },
    ];
    ...
    fields.push({ type: 'TEXT', label: '[SECTION]Comments / notes', required: false }, { type: 'TEXT', label: 'Comments / notes', required: false });
    return fields;
}
