...
exports.buildConfinedSpaceEntryPermitFields = buildConfinedSpaceEntryPermitFields;
function buildContinuousMonitoringRows(prefix, slots) {
    const out = [];
...
function buildConfinedSpaceEntryPermitFields() {
    return [
        ...
        {
            type: 'TEXT',
            label: '[INFO]Acceptable limits: O₂ 19.5% to 23%. Hot work: under 10% LEL. Cold work: under 10% LEL (clean and inspect under 20% LEL). Carbon monoxide: under 6 ppm. Carbon dioxide: under 1250 ppm. Hydrogen sulfide: under 2.5 ppm.',
            required: false,
        },
