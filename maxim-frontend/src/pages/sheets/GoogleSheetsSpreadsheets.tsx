...
export function GoogleSheetsSpreadsheets() {
  const spreadsheets: { id: string; name: string; lastModified: string }[] = []
    ...
    <div className="space-y-6 animate-fade-in">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-neutral-500 dark:text-neutral-400 mt-0.5">Connect Google Sheets to sync job entries</p>
        </div>
      </div>
      {spreadsheets.length === 0 ? (
        <Card padding="lg" className="text-center text-neutral-500 dark:text-neutral-400">
          <p>No spreadsheets connected. Connect your Google account to sync job entries from email.</p>
        </Card>
      ) : (
