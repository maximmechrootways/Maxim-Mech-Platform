...
import { getSignatureRequest, listSignatureRequests } from '@/api/signatureRequests'
...
export function SignatureCapture() {
  ...
  useEffect(() => {
    if (id) getSignatureRequest(id).then((r) => setRequest(r ?? null))
    else listSignatureRequests().then((list) => setRequest(list[0] ?? null))
  }, [id])
