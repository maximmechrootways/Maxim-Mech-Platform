...
import { listTrainingCertifications } from '@/api/training'

export function TrainingList() {
  const [list, setList] = useState<Awaited<ReturnType<typeof listTrainingCertifications>>>([])
  useEffect(() => { listTrainingCertifications().then(setList) }, [])
  return (
