...
/** Injury trend data from API when available; empty until then */
const INJURY_TREND_DATA: { month: string; reported: number; closed: number }[] = []
...
export function SafetyAnalytics() {
  ...
  const injuryTrendData = INJURY_TREND_DATA.length > 0 ? INJURY_TREND_DATA : [{ month: '—', reported: 0, closed: 0 }]
