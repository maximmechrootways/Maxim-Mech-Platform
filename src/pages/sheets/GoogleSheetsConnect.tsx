  ...
  return (
    <div className="max-w-md mx-auto space-y-6 animate-fade-in">
      ...
      <Card padding="lg">
        ...
        <Button className="w-full mt-4" onClick={connect}>Continue (demo — no OAuth)</Button>
        <p className="text-xs text-neutral-500 mt-3">We will request read/write access to spreadsheets you select. This demo skips real Google sign-in and goes straight to spreadsheet selection.</p>
      </Card>
    </div>
  )
}
