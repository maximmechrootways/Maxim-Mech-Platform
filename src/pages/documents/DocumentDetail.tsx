...
import { getEmailThreadByDocumentId } from '@/api/emailThreads'
...
export function DocumentDetail() {
  ...
  const [thread, setThread] = useState<EmailThread | undefined>(undefined)
  useEffect(() => { if (doc?.id) getEmailThreadByDocumentId(doc.id).then(setThread) }, [doc?.id])
