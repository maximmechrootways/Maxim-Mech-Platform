...
export function FrankChat() {
  ...
  const send = () => {
    ...
    let reply = DEFAULT_REPLIES.default
    ...
    } else if (lower.includes('policy')) reply = DEFAULT_REPLIES.policy
    else if (lower.includes('incident')) reply = DEFAULT_REPLIES.incident
    setTimeout(() => {
